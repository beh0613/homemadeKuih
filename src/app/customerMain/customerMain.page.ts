...
@Component({
  ...
  templateUrl: './customerMain.page.html',
  styleUrls: ['./customerMain.page.scss'],
  standalone: true,
  imports: [
    CommonModule, 
    IonHeader, IonToolbar, IonTitle, IonContent, IonButton, IonIcon, 
...
export class CustomerMainPage {
  kuihs = [
    {
      steamkuih_engName: "Tapioca Kuih",
      steamkuih_chineseName: "木薯糕",
      steamkuih_price: 0.70,
      image: "assets/tapioca.webp"
    },
    {
      steamkuih_engName: "Kaya Kuih",
      steamkuih_chineseName: "兰花咖椰糯米糕",
      steamkuih_price: 0.60,
      image: "assets/kayakuih.webp"
    },
    {
      steamkuih_engName: "Kuih Koci",
      steamkuih_chineseName: "三角椰丝糕",
      steamkuih_price: 1.30,
      image: "assets/KKC.webp"
    },
    {
